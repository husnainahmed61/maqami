...
$route['forgetpassword']='Login/restpassword';
$route['setpassword']='Login/checkemailfornewpassword';
$route['add-product']='Dashboard/addproduct';
$route['save-product']='Dashboard/productDataadd';
$route['view-product']='dashboard/Listproduct';
$route['update-product/(:num)']='dashboard/updateproductdata/$1';
$route['product-variation']='dashboard/prductVariationView';
