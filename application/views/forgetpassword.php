...
<div class="container">
	...
	<form id="contact" class="con" action="setpassword" method="post">
		<div class="row">
...
">
    ...
    font-size: 23px;
    font-weight: bold;
    text-shadow: 3px 3px 5px #c1c3c1;">We will Send Password Through E-mail</h3>
		<div>
			<?php
    ...
    top: -3px;
    color: #fff;
    font-size: 17px;" class="fa fa-key" aria-hidden="true"></i><input name="submit" type="submit" id="contact-submit" class="login-btn" data-submit="...Sending" value="Recovor Password"></span>
			<a href="#" class="forgetpassword">Go Back Login</a>
		</fieldset>
	</form>
</div>
</body>
