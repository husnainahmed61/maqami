			...
			<div class="col-sm-12">
				...
				<div class="panel panel-bd lobidrag invent-main">
					...
					<div class="panel-body addit">
						<form action="add-variation" method="post" accept-charset="utf-8">
							...
							<div class="row">
								<div class="col-sm-10">
									...
									<input class="form-control" id="category_name" name="variation_name" type="text" required>
								</div>
							</div>
							<div class="form-group row" style="margin-top: 10px;">
								<div class="col-sm-10">
									<button type="submit" value="Yes" name="variation"class="btn btn-large btn-success" style="padding: 7px;font-size: 21px; float: right;">Save</button>
								</div>
							</div>
						</form>
					</div>
